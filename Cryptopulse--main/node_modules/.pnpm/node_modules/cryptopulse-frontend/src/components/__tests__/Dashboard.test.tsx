...
vi.mock('@/components/WorldClassDashboard', () => ({
  __esModule: true,
...
vi.mock('@/components/RiskMonitor', () => ({
  __esModule: true,
  default: () => <div data-testid="risk-monitor">Risk Monitor</div>,
}));

vi.mock('@/components/PerformanceAnalytics', () => ({
  __esModule: true,
...
vi.mock('@/components/ExchangeIntegration', () => ({
  __esModule: true,
...
vi.mock('@/lib/api', () => ({
  ...
  fetchTradingData: vi.fn().mockResolvedValue({
    trades: [],
...
vi.mock('@/store/utils/performance', () => ({
  performanceMonitor: {
    markStart: vi.fn(),
    markEnd: vi.fn(),
