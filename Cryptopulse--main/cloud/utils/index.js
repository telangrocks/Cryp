// =============================================================================
// CryptoPulse Cloud Utils - Utility Functions (Express Router)
// =============================================================================
...
// Utility functions endpoint
router.get('/functions', (req, res) => {
  res.json({
    success: true,
    data: {
      validation: Object.keys(validationUtils),
      encryption: Object.keys(encryptionUtils),
      date: Object.keys(dateUtils),
      trading: Object.keys(tradingUtils),
      api: Object.keys(apiUtils),
      error: Object.keys(errorUtils),
      logging: Object.keys(loggingUtils),
      rateLimit: Object.keys(rateLimitUtils)
    }
  });
});
...
router.post('/validate', (req, res) => {
  try {
    ...
    switch (type) {
      case 'email':
        result = validationUtils.isValidEmail(value);
        break;
      case 'phone':
        result = validationUtils.isValidPhone(value);
        break;
      case 'tradingPair':
        result = validationUtils.isValidTradingPair(value);
        break;
      case 'amount':
        result = validationUtils.isValidAmount(value);
        break;
      case 'price':
        result = validationUtils.isValidPrice(value);
        break;
      default:
        return res.status(400).json({
          success: false,
...
// Trading calculations endpoint
router.post('/trading/calculate', (req, res) => {
  try {
    ...
    switch (operation) {
      case 'profitLoss':
        result = tradingUtils.calculateProfitLoss(
          params.entryPrice,
          params.exitPrice,
          params.quantity,
          params.side
      ...
      case 'profitPercentage':
        result = tradingUtils.calculateProfitPercentage(
          params.entryPrice,
          params.exitPrice,
          params.side
        );
        break;
      case 'positionSize':
        result = tradingUtils.calculatePositionSize(
        ...
        break;
      case 'movingAverage':
        result = tradingUtils.calculateMovingAverage(
          params.prices,
          params.period
        );
        break;
      case 'rsi':
        result = tradingUtils.calculateRSI(
          params.prices,
          params.period
        );
        break;
